...
public class TypedefAspect
{
   ...
   /**
    * @@ org.jboss.aop.TypeDef ("class(org.jboss.test.aop.annotated.VariaPOJO)")
    */
   public static Typedef myTypedef;

   /**
    * @@org.jboss.aop.Bind (pointcut="execution(* $typedef{org.jboss.test.aop.annotated.TypedefAspect.myTypedef}->methodWithTypedef())")
    */
