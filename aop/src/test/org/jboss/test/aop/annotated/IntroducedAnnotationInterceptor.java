 ...
 * @@org.jboss.aop.Bind (pointcut="all(org.jboss.test.aop.annotated.IntroducedAnnotationPOJO)")
 */
public class IntroducedAnnotationInterceptor implements Interceptor
{
   /**
    * @@org.jboss.aop.AnnotationIntroductionDef (expr="method(* org.jboss.test.aop.annotated.IntroducedAnnotationPOJO->annotationIntroductionMethod())", invisible=false, annotation="@org.jboss.test.aop.annotated.MyAnnotation (string='hello', integer=5, bool=true)")
    */
