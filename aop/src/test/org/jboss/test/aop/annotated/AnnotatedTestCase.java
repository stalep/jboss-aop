...
//      testAspectFactory();
   ...
   public void testBinding() throws Exception
   {
      ...
      try
      {
         ...
         vm = (AspectPerVM) AspectManager.instance().getPerVMAspect("org.jboss.test.aop.annotated.AspectPerVM");
         ...
         perClass = (AspectPerClass) advisor.getPerClassAspect("org.jboss.test.aop.annotated.AspectPerClass");
         ...
         perClass2 = (AspectPerClass) advisor.getPerClassAspect("org.jboss.test.aop.annotated.AspectPerClass");
         ...
         AspectPerInstance perInstance = (AspectPerInstance) ia.getPerInstanceAspect("org.jboss.test.aop.annotated.AspectPerInstance");
         ...
         perInstance = (AspectPerInstance) ia.getPerInstanceAspect("org.jboss.test.aop.annotated.AspectPerInstance");
