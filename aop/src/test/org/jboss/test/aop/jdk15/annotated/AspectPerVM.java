        ...
        public class AspectPerVM
{
   ...
   @PointcutDef("execution(org.jboss.test.aop.jdk15.annotated.AnotherPOJO->new(..))")
   public static Pointcut anotherPOJOConstructors;

   @PointcutDef("get(* org.jboss.test.aop.jdk15.annotated.AnotherPOJO->field)")
   public static Pointcut anotherPOJOFieldReads;

   @PointcutDef("set(* org.jboss.test.aop.jdk15.annotated.AnotherPOJO->field)")
   public static Pointcut anotherPOJOFieldWrites;

   @PointcutDef("execution(* org.jboss.test.aop.jdk15.annotated.AnotherPOJO->*(..))")
   public static Pointcut anotherPOJOPublicMethods;

   @PointcutDef("org.jboss.test.aop.jdk15.annotated.AspectPerVM.anotherPOJOFieldWrites OR org.jboss.test.aop.jdk15.annotated.AspectPerVM.anotherPOJOFieldReads")
   public static Pointcut anotherPOJOFields;

   @Prepare ("all(org.jboss.test.aop.jdk15.annotated.PreparePOJO)")
   public static Pointcut preparePOJO;


   @Bind(pointcut = "execution(org.jboss.test.aop.jdk15.annotated.POJO*->new())")
   ...
   @Bind(pointcut = "execution(void org.jboss.test.aop.jdk15.annotated.POJO*->someMethod())")
   ...
   @Bind(pointcut = "set(* org.jboss.test.aop.jdk15.annotated.POJO*->field)")
   ...
   @Bind(pointcut = "get(* org.jboss.test.aop.jdk15.annotated.POJO*->field)")
   public Object fieldAdvice(FieldReadInvocation invocation) throws Throwable
   {
    ...
    @Bind(pointcut = "org.jboss.test.aop.jdk15.annotated.AspectPerVM.anotherPOJOFields OR org.jboss.test.aop.jdk15.annotated.AspectPerVM.anotherPOJOConstructors OR org.jboss.test.aop.jdk15.annotated.AspectPerVM.anotherPOJOPublicMethods")
