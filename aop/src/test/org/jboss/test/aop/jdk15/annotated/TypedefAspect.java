...
public class TypedefAspect
{
   ...
   @TypeDef ("class(org.jboss.test.aop.jdk15.annotated.VariaPOJO)")
   public static Typedef myTypedef;

    @Bind (pointcut="execution(* $typedef{org.jboss.test.aop.jdk15.annotated.TypedefAspect.myTypedef}->methodWithTypedef())")
