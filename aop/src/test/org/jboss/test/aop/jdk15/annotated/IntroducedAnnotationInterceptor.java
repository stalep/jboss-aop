...
@Bind (pointcut="all(org.jboss.test.aop.jdk15.annotated.IntroducedAnnotationPOJO)")
      public class IntroducedAnnotationInterceptor implements Interceptor
{
   @AnnotationIntroductionDef (expr="method(* org.jboss.test.aop.jdk15.annotated.IntroducedAnnotationPOJO->annotationIntroductionMethod())", invisible=false, annotation="@org.jboss.test.aop.jdk15.annotated.MyAnnotation (string='hello', integer=5, bool=true)")
