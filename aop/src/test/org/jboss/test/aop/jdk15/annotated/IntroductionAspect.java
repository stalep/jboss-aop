...
{
   @Mixin (target=org.jboss.test.aop.jdk15.annotated.NoInterfacesPOJO.class, interfaces={java.io.Externalizable.class})
   ...
   @Introduction (typeExpression="has(* *->pojoInterfaces2Method(..))", interfaces={org.jboss.test.aop.jdk15.annotated.EmptyInterface.class})
